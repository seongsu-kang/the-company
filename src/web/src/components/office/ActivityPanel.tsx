...
export default function ActivityPanel({
  jobId, sessionId, title, color, variant, style, onClose, onMinimize, onDone, onNavigateToJob, onOpenKnowledgeDoc,
}: ActivityPanelProps) {
  const { events, status, textOutput, childJobIds } = useActivityStream(jobId, sessionId);
